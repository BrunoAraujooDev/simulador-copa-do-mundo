...
import { RoundSection, MatchupDiv, PlayoffContainer, SpanResult, SpanPenalty, SendButton, ImgFlag, FigureFlag, NoDataDiv } from "./style"
import './index.css';
    ...
    return (
        <PlayoffContainer>
            {teamsQualified.winner[0] != undefined ?
                ...
                :
                <NoDataDiv>
                    <Trophy size={60} weight="bold" />
                    <p>Retorne para a página Home para iniciar a simulação</p>
                </NoDataDiv>
            }
